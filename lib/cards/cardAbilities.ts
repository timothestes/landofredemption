 ...
 * Duplicated in spacetimedb/src/cardAbilities.ts.
 */
...
export function abilityLabel(a: CardAbility): string {
  switch (a.type) {
    ...
    case 'band_heroes_from_deck':
      return `Band all ${a.referenceBook} Heroes from deck into battle`;
    ...
    case 'toggle_top_deck_reveal':
      return 'Play with top card of deck face up';
    case 'custom':
      return a.label;
  }
}
 ...
 * counts 1. Duplicated in spacetimedb/src/cardAbilities.ts; parity test
 * enforces equality.
 */
